...
### Diverging color schemes and the cognate gray ones {.unlisted}
...
p1 <- colors_diverging_blue2brown |> 
    plot_scheme("colors_diverging_blue2brown")
...
### New sections about e1.1.5: {.unlisted .unnumbered}
...
See <https://github.com/iamhealthy/tidyplots-book/blob/main/NEWS.md> for additional corrections to typos and other issues.
