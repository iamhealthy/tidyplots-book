...
![Jan Broder Engler (<https://jbengler.de/>).](images/broder_avatar.jpg){width="35%" fig-align="center"}

- 👉`Tidyplots`📦 is an R package to generate **publication-ready plots for scientific papers**, created by Jan Broder Engler [@tidyplots].
...
:::{.callout-note icon="true"}
The figures across this book use the high-contrast qualitative color scheme by default, unless a different scheme is explicitly specified in the code.
