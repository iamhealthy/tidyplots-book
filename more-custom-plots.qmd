...
df |> 
  ...
  add_annotation_text(
    text = "Personally, I introduce tidyplots first,\nshowcase its power but also its limitations.\n\nThis naturally builds motivation to explore ggplot2\n(in some, not all people).",
    x = 1,
    y = 1,
    fontsize = 11,
  ...
  remove_y_axis() |> 
  save_plot(
    "images/tidyplots-motivation.png",
    view_plot = FALSE)
```

![](images/tidyplots-motivation.png){width="100%" fig-align="center"}
...
patchwork::wrap_plots(p1, p2, p3, p4, p5, design = design) |> 
  save_plot("images/sequential-issues.png",
    view_plot = FALSE, width = 130, height = 200)
```

![Sequential issues.](images/sequential-issues.png){width="84%" fig-align="center"}
...
![Sequential issues (using `add()`).](images/sequence_issues_2.png){width="100%" fig-align="center"}
...
patchwork::wrap_plots(p1, p2, p3, ncol = 1) |> 
  save_plot("images/axis-chinese-english.png",
    view_plot = FALSE, width = 145, height = 205)
```

![Change Chinese date axis labels into English ones.](images/axis-chinese-english.png){width="95%" fig-align="center"}
...
![Color each point within each group.](images/different_point_colors.png){width="95%" fig-align="center"}
...
#| echo: false
patchwork::wrap_plots(p1, p2, p3, p4, ncol = 2) |> 
  save_plot("images/relative-to-control.png",
    view_plot = FALSE, width = 170, height = 140)
```

![Relative to control.](images/relative-to-control.png){fig-align="center" width="100%"}
...
#| echo: false
patchwork::wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 2) |> 
  save_plot("images/tick-for-subgroup.png",
    view_plot = FALSE, width = 160, height = 210)
```

![Tick for subgroup.](images/tick-for-subgroup.png){fig-align="center" width="100%"}
...
#| echo: false
patchwork::wrap_plots(p1, p2, p3, p4, ncol = 2) |> 
  save_plot("images/segmented-x-axis-line.png",
    view_plot = FALSE, width = 130, height = 140)
```

![Segmented x axis line.](images/segmented-x-axis-line.png){fig-align="center" width="100%"}
...
#| warning: false
patchwork::wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 2) |> 
  save_plot("images/nested-bar-plot.png",
    view_plot = FALSE, width = 160, height = 200)
```

![Nested bar plot.](images/nested-bar-plot.png){fig-align="center" width="100%"}
...
patchwork::wrap_plots(p1, p2, p3, p4, p5, ncol = 2) |> 
  save_plot("images/stacked-bar-errorbar.png",
    view_plot = FALSE, width = 160, height = 205)
```

![Stacked bar plot with error bar.](images/stacked-bar-errorbar.png){fig-align="center"  width="100%"}
...
#| echo: false
patchwork::wrap_plots(p1, p2, p3, p4, ncol = 2) |> 
  save_plot("images/stacked-bar-data-label.png",
    view_plot = FALSE, width = 165, height = 140)
```

![Stacked bar plot with data labels.](images/stacked-bar-data-label.png){fig-align="center" width="100%"}

## Pie and donut plots with data labels
...
#| echo: false
patchwork::wrap_plots(p1, p2, p3, p4, ncol = 2) |> 
  save_plot("images/donut-pie_labels.png",
    view_plot = FALSE, width = 155, height = 120)
```

![Pie and donut plots with labels.](images/donut-pie_labels.png){fig-align="center" width="100%"}